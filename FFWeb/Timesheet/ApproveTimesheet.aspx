...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="Server">
    ...
    <asp:LinqDataSource ID="gvTimesheetHeader" runat="server" 
        ...
        Select="new (empId, tsDate, status, comments)" 
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
        ...
        <Fields>
            ...
            <asp:BoundField DataField="wpId" HeaderText="wpId" ReadOnly="True" 
                SortExpression="wpId" />
            <asp:BoundField DataField="sat" HeaderText="sat" ReadOnly="True" 
                SortExpression="sat" />
            <asp:BoundField DataField="sun" HeaderText="sun" ReadOnly="True" 
                SortExpression="sun" />
            <asp:BoundField DataField="mon" HeaderText="mon" ReadOnly="True" 
                SortExpression="mon" />
            <asp:BoundField DataField="tue" HeaderText="tue" ReadOnly="True" 
                SortExpression="tue" />
            <asp:BoundField DataField="wed" HeaderText="wed" ReadOnly="True" 
                SortExpression="wed" />
            <asp:BoundField DataField="fri" HeaderText="fri" ReadOnly="True" 
                SortExpression="fri" />
    ...
    <asp:LinqDataSource ID="dvTimesheetHeader" runat="server" 
        ...
        Select="new (empId, notes, tsDate, projId, wpId, sat, sun, mon, tue, wed, fri, thu)" TableName="TimeSheetEntries" 
        Where="empId == @empId">
        <WhereParameters>
