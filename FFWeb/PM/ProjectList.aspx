...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
    <br />
    <div id="divproj">
        <asp:Label ID="lblMsg" runat="server" Text="List of Active Projects:" Font-Bold="true" Font-Size="Large"></asp:Label>
        <br />
    ...
    <div id="divunactiveproj">
        <asp:Label ID="lblMsg2" runat="server" Text="List of Inactive Projects:" Font-Bold="true" Font-Size="Large"></asp:Label>
        <br />
        <div id="Div1" class="divline" runat="server" />
        <br />
                <asp:GridView ID="gvUnassignedProj" runat="server" 
                    OnRowCommand="gvUnassignedProj_RowCommand" AutoGenerateColumns="False" 
                    BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
                    CellPadding="3" CssClass="cent">
                    <Columns>
                        <asp:BoundField DataField="projID" HeaderText="Project ID" 
