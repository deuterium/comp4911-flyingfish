                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CompareValidator ID="cvUnallocated" runat="server" Visible="false" ControlToValidate="tbUnalloc" 
                                    ErrorMessage="Invalid Budget." ForeColor="Red" Operator="DataTypeCheck" 
                                    Type="Currency" />
            ...
            <br /><br />
                    ...
                    <asp:GridView ID="gvWorkPackages" runat="server" 
                        ...
                        <Columns>
                            ...
                            <asp:ButtonField Text="View" CommandName="btnView" 
                                ButtonType="Button" />
                            <asp:ButtonField ButtonType="Button" CommandName="btnDeactivate" 
                                Text="Deactivate" />
                        </Columns>
                    ...
                    <br />
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="projId" HeaderText="Project ID" 
                                SortExpression="projId" Visible="False" />
                            <asp:ButtonField ButtonType="Button" CommandName="btnActivate" 
                                Text="Activate" />
                        </Columns>
                        <FooterStyle BackColor="White" ForeColor="#000066" />
                        <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" />
